...
import com.example.fbvideodownloader.fragment.Cach1Framgnet;
import com.example.fbvideodownloader.fragment.Cach2Fragment;
...
//            }
//        }).attach();
        findViewById(R.id.btn_DaHieu).setOnClickListener(new View.OnClickListener() {
            @Override
